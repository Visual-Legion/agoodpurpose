...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            // Slick
            wp_register_script('slick-js', get_template_directory_uri() . '/js/lib/slick.min.js', array());
...
function html5blank_styles()
{
    ...
    if (HTML5_DEBUG) {
        ...
        // Slick style
        wp_register_style('slick-css', get_template_directory_uri() . '/css/lib/slick.css', array());
        wp_enqueue_style('slick-css');

        wp_register_style('slick-theme', get_template_directory_uri() . '/css/lib/slick-theme.css', array());
...
function tribe_custom_theme_text ( $translation, $text, $domain ) {
	...
	$custom_text = array(
        ...
        'Export Events' => 'EXPORT TO CALENDAR'
	);
...
if ( class_exists( 'Woocommerce' ) && class_exists( 'Tribe__Tickets_Plus__Commerce__WooCommerce__Main' ) ) {
    ...
    add_action( 'tribe_events_single_event_before_the_content', $display_function );
}